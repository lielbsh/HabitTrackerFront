...
const Login = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-tr from-background-lightPink via-background-lightPurple to-purple-400 h-screen">
